...
Having completed systems to handle the information extraction tasks presented by ScienceIE, the next major part of the project was to explore how this information can be utilised for researchers. 
...
\begin{itemize}
	\item The first is simply a list of papers. When selected, the user will be shown the view described below:
